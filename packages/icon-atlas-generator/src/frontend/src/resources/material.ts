...
import { croppedTextureDataUrlCache } from '../cacheStore'
...
export async function loadTextureImage(textureData: TextureData) {
  ...
  let cachedCroppedTextureDataUrl = croppedTextureDataUrlCache.get(textureKey)
  if (cachedCroppedTextureDataUrl == null) {
    ...
    croppedTextureDataUrlCache.set(textureKey, croppedTextureDataUrl)
