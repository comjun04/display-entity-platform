// almost copy of packages/app/src/utils.ts
// TODO: refactor and move duplicated utility code to @depl/shared package

import { ModelElement, ModelFaceKey } from '@depl/shared'
